...
export default class AddCandidate extends Component {
  ...
  addCandidate = async () => {
    await this.state.ElectionInstance.methods
      .addCandidate(this.state.name, this.state.party)
          ...
          <div className="container-item">
            <form className="form">
              ...
              <button
                className="btn-add"
                disabled={
                  this.state.name.length < 3 || this.state.name.length > 21
                }
    ...
    return (
      <>
        <div className="container-list success">
          ...
          >
            {candidate.id}. <strong>{candidate.name}</strong>:{" "}
            {candidate.party}
          </div>
        </div>
      </>
  ...
  return (
    <div className="container-main" style={{ borderTop: "1px solid" }}>
      {/* <div className="container-item info"> */}
       <br></br> <center>Candidates List</center>
      {/* </div> */}
      {candidates.length < 1 ? (
